...
func main() {
	...
	adminAuthH    := adminhandler.NewAuthHandler(authService, adminUserRepo, tenantRepo)
	...
	adminQuotasH  := adminhandler.NewQuotasHandler(quotaRepo, auditRepo, cache, adminUserRepo)
