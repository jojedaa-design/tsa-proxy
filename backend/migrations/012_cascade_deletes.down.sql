-- Revert FK delete rules from CASCADE back to NO ACTION
...
BEGIN
    FOR r IN (
        ...
        EXECUTE format('ALTER TABLE %I ADD CONSTRAINT %I FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE NO ACTION',
            r.tablename, r.tablename || '_tenant_id_fkey');
    END LOOP;
END $$;
